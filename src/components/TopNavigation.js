            ...
            {this.props.isAuthenticated ? (
              <React.Fragment>
                ...
                <Link
                  ...
                  <span id="activities_count" />
                </Link>
                <Link
                  to="/new_post"
                  style={{ marginRight: 15, position: "relative" }}
                  title="Post a new subject">
                ...
                <div className="dropdown">
                  <span
                    ...
                    <img
                      src={this.state.user_details.profile_picture}
                      alt="Elmer Logo"
                  ...
                  <div
                    ...
                    <Link
                      ...
                      to={`/u/${this.state.user_details.username}`}>
                      {this.state.user_details.screen_name}
                    </Link>
                    ...
                    <div className="dropdown-divider" />
                    <Link className="dropdown-item" to="/new_board">
                      Create Board
                    </Link>
                    <Link className="dropdown-item" to="/my_boards">
                      Your Boards
                    </Link>
                    <div className="dropdown-divider" />
                    ...
                    <Link
                      className="dropdown-item font-weight-light"
                      to="feedback">
                      Send Feedback
                    </Link>
                    <span
              ...
              <React.Fragment>
                <Link className="btn btn-primary btn-sm login_btn" to="/login">
                  Login
                </Link>
                <Link
                  className="btn btn-success btn-sm signup_btn"
                  to="/signup">
                  Sign Up
                </Link>
              </React.Fragment>
