  ...
  <React.Fragment>
    ...
    <div className="card border-light">
      ...
      <ul className="list-group list-group-flush" style={{ fontSize: 14 }}>
        ...
        <li className="list-group-item">
          <b>Description: </b>
          {board_details.description}
        </li>
        <li className="list-group-item">
          <b>Total Posts: </b>
          {board_details.total_posts}
        </li>
        <li className="list-group-item">
          <b>Admins: </b>
          Add Later
        ...
        <li className="list-group-item">
          <b>Subscribers: </b>
          <span id="board_subscribers">{board_details.subscribers_count}</span>
        </li>
      </ul>
    </div>
  </React.Fragment>
